    ...
    <div class="col-lg-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
                <h3 class="card-title">تعديل الكتاب </h3>
            </div>
            <!--begin::Form-->
            <form action="books/update/{{$book->id}}" method="post" class="form" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label>العنوان</label>
                            <input type="text" name="name" value="{{old('name',$book->name)}}" class="form-control  @error('name') is-invalid @enderror" />
                            @error('name')
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="price" value="{{old('price',$book->price)}}" class="form-control  @error('price') is-invalid @enderror" />
                            @error('price')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input type="int" name="Release_Date" value="{{old('Release_Date',$book->	Release_Date)}}" class="form-control  @error('Release_Date') is-invalid @enderror" />
                            @error('Release_Date')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6 mt-5">
                        ...
                        <div class="custom-file  @error('image') is-invalid @enderror">
                            <input name="image" value="{{old('image',$book->image)}}" type="file" class="custom-file-input" id="customFileLang" lang="ar">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            ...
                            <div class="card-body     @error('Description_book') is-invalid @enderror">
                                ...
                                {{old('Description_book',$book->Description_book)}}
                                </textarea>
